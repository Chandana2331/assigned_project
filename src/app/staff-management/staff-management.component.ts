...
import moment from 'moment'; // Ensure moment is correctly imported as default
...
export class StaffManagementComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private adapter: DateAdapter<any>, private datePipe: DatePipe) {}
